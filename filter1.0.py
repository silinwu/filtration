...
#Before test you only need to modify line 36-41
...
sheet1 = book.add_sheet('filter')                                                            #a sheet in excel named by filter 
sheet1.write(0,0,'t(s)')                                                                     #write in the cakelength sheet of excel in row 1 and column 1
sheet1.write(1,0,0)                                                                          #write in row 2 and colunm 1 as 0
sheet1.write(0,5,'Discharge(m3/s)')                                                          #write in row 1 and column 6
sheet1.write(1,5,0)                                                                          #write in row 2 and column 6 as 0
sheet1.write(0,7,'Hydraulic conductivity of the filter(m/s)')                                #write in row 1 and column 8
sheet1.write(1,7,np.nan)                                                                     #write as nan
sheet1.write(0,8,'Permittivity of the filter(m/s)')                                          #write in row 1 and column 9
sheet1.write(1,8,np.nan)                                                                     #write as nan                                                                     
######################################################################################################################################################################################################
######################################################################################################################################################################################################
#########basic parameters need to be modified,and must not modify the others #############################################################################################################################################################################
RR = 20                                     												#the filter particle
Pny = 3                                     												#the column of the filter
pdx = 117                                  													#AOS of the filter
pdy = 117                                  													#AOS of the filter
prefix = "/home/foggy/dlvo-master/testfilter_"  											#the route
numberhdf5 = 150                                											#number of the filter test, at least 80, to make sure the data is stable.
###################read hdf5 #########################################################################################################################################################################
######################################################################################################################################################################################################
######################################################################################################################################################################################################
Pnx = 1
...
wb = xlrd.open_workbook('testfilter.xls')                                                     #open the excel named testfilter.xls
