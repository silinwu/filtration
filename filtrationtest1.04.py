...
#######particle################################################################################################
#R = 10																	 # *****************
#pnx = 8                                                        		 #used when particle filtration  *****************
#pny = 29																 #used when particle filtration  *****************
#l  = 19.25																 #used when particle filtration  *****************
...
book.save('testfiltrationD3.xls')                                                               #save the data in the excel
######### read the excel data that output last step and plot the figures#################################################################################################################################
wb = xlrd.open_workbook('testfiltrationD3.xls')                                                 #open the excel
